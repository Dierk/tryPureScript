...
showShape (Clipped _ p w h) =
  "Clipped picture to [" <> showShape (Rectangle p w h) <> "]"
...
getCenter (Clipped pic p w h) = getCenter (Rectangle p w h) 
...
shapeBounds (Clipped _ p w h) = shapeBounds (Rectangle p w h) 
