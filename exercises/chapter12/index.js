...
(function($PS) {
  ...
  var productions = function (v) {
      ...
      throw new Error("Failed pattern match at Example.LSystem (line 56, column 1 - line 56, column 34): " + [ v.constructor.name ]);
  };
          ...
          var interpret = function (state) {
              return function (v1) {
                  ...
                  if (v1 instanceof F) {
                      ...
                      return function __do() {
                          Graphics_Canvas.moveTo(ctx)(state.x)(state.y)();
                  ...
                  throw new Error("Failed pattern match at Example.LSystem (line 74, column 5 - line 74, column 49): " + [ state.constructor.name, v1.constructor.name ]);
              };
          };
          Graphics_Canvas.setStrokeStyle(ctx)("#000")();
          return Graphics_Canvas.strokePath(ctx)(lsystem(Effect.monadEffect)(initial)(productions)(interpret)(5)(initialState))();
      };
      throw new Error("Failed pattern match at Example.LSystem (line 69, column 3 - line 69, column 47): " + [ v.constructor.name ]);
  });
