...
(function($PS) {
  ...
  var lsystem2 = function (dictMonad) {
      return function (s) {
  ...
  var lsystem1 = function ($copy_s) {
      return function ($copy_v) {
          return function ($copy_v1) {
              ...
              var $tco_done = false;
              var $tco_result;
              function $tco_loop(s, v, v1) {
                  if (v1 === 0) {
                      $tco_done = true;
                      return s;
                  };
                  $tco_var_s = Data_Array.concatMap(v)(s);
                  $tco_var_v = v;
                  $copy_v1 = v1 - 1 | 0;
                  return;
              };
              while (!$tco_done) {
                  $tco_result = $tco_loop($tco_var_s, $tco_var_v, $copy_v1);
              };
              return $tco_result;
          };
      };
  ...
  var main = Data_Functor["void"](Effect.functorEffect)(function __do() {
      ...
      if (v instanceof Data_Maybe.Just) {
          ...
          var productions2 = function (v1) {
              ...
              throw new Error("Failed pattern match at Example.LSystem (line 82, column 5 - line 82, column 41): " + [ v1.constructor.name ]);
          };
          var interpret2 = function (state) {
              return function (v1) {
                  if (v1 instanceof L) {
          ...
          var initial2 = [ M.value ];
          Graphics_Canvas.setStrokeStyle(ctx)("#000")();
          Graphics_Canvas.setShadowOffsetX(ctx)(10.0)();
          Graphics_Canvas.setShadowOffsetY(ctx)(40.0)();
          Graphics_Canvas.setShadowBlur(ctx)(40.0)();
          Graphics_Canvas.setShadowColor(ctx)("#444")();
          return Graphics_Canvas.fillPath(ctx)(lsystem2(Effect.monadEffect)(lsystem1(initial2)(productions2)(3))(interpret2)(initialState))();
      };
      throw new Error("Failed pattern match at Example.LSystem (line 59, column 3 - line 59, column 47): " + [ v.constructor.name ]);
  });
  ...
  exports["lsystem1"] = lsystem1;
  exports["lsystem2"] = lsystem2;
  exports["L"] = L;
  exports["R"] = R;
  exports["F"] = F;
  exports["M"] = M;
